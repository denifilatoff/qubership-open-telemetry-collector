module github.com/Netcracker/qubership-open-telemetry-collector/exporter/logtcpexporter

go 1.25.0

require (
	github.com/Netcracker/qubership-open-telemetry-collector/common/graylog v0.0.0-20260311100748-e292cfb84bce
	github.com/Netcracker/qubership-open-telemetry-collector/utils v0.0.0-20260311100748-e292cfb84bce
